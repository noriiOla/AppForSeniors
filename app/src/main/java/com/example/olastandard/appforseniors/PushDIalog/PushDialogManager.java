...
public class PushDialogManager {
    ...
    public void showDialogWithYesNoButtons(AppCompatActivity activity, String dialogMessage, final PushDialogButtonsYesNoInterface buttonsListeners) {
        ...
        buttonYes.setBackground(activity.getResources().getDrawable(R.drawable.button_shape_push_yes));
        buttonNo.setBackground(activity.getResources().getDrawable(R.drawable.button_shape_push_no));
    ...
    public void showDialogWithOkButton(AppCompatActivity activity, String dialogMessage, final PushDialogButtonsOkInterface buttonsListeners) {
        ...
        TextView title = (TextView) dialog.findViewById(R.id.popup_title);
        title.setText(activity.getResources().getText(R.string.popup_title_information));
