        ...
        this._toolbarSaveButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (titleText.isEmpty()) {
                    ...
                    System.out.println("nagranie: " + title);
                    voiceNotesManager.saveRecord(title);

                    (new PushDialogManager()).showDialogWithOkButton(AddVoiceNoteActivity.this,
                            "zapisano nagranie: " + title , new PushDialogButtonsOkInterface(){
                                @Override
